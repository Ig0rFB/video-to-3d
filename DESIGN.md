...
- `02_run_colmap.py` uses **SINGLE** camera mode, exhaustive matching for small sets, then picks the largest reconstruction and normalises it to `sparse/0` (`_select_best_model`, `_export_best_model_to_sparse_zero`).
